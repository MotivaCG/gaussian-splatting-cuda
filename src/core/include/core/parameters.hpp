...
namespace lfs::core {
    namespace param {
        ...
        enum class BackgroundMode {
            ...
            TileNoise   // Tile-based saturated CMY+RGB pattern, shifted each iter, regenerated every 100 iters
        };
        ...
        struct LFS_CORE_API OptimizationParameters {
            ...
            float means_lr_mul_start = 1.0f; // means_lr multiplier
            float means_lr_mul_end = 1.0f;   // means_lr_end multiplier        
            ...
            float darkness_boost = 2.0f;              // FocusedSegment focus on dark colors
