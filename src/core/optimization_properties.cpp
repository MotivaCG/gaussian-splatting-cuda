        ...
        PropertyGroupBuilder<OptimizationParameters>("optimization", "Optimization")
            ...
            .enum_prop(&OptimizationParameters::mask_mode,
                       ...
                       {{"None", MaskMode::None, "training.options.mask.none", "none"},
                        ...
                        {"Attention", MaskMode::Attention, "training.options.mask.attention", "attention"}},
                        // SMN end
            ...
            .enum_prop(&OptimizationParameters::bg_mode,
                       ...
                       {{"SolidColor", BackgroundMode::SolidColor, "training.options.bg.color", "solid_color"},
                        ...
                        // SMN begin — pseudorandom background
                        {"Pseudorandom", BackgroundMode::Pseudorandom, "training.options.bg.pseudorandom", "pseudorandom"}},
                        // SMN end
                       "Background mode")
            ...
            .bool_prop(&OptimizationParameters::skip_intermediate,
                       "skip_intermediate", "Skip Intermediate Saves", d.skip_intermediate,
                       "Skip intermediate saves (step checkpoints, regular-phase PLY, .ppisp sidecars); keep only the final and pre-prune PLYs")
            .locale("training_params.skip_intermediate")
            .tooltip("training.tooltip.skip_intermediate")
            .all_strategies()
            .string_prop(&OptimizationParameters::smn_switch_strategy_to,
                         "smn_switch_strategy_to", "Switch To", d.smn_switch_strategy_to,
                         "Target strategy for the in-process switch (set via the \"hybrid\" strategy preset); empty disables it")
            .all_strategies()
